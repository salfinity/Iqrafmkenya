      ...
      text-white px-4 lg:px-8 ly-2 lg:py-4 rounded-full
       dark:bg-slate-800"
          ...
          <Modal isOpen={isModalOpen} onClose={handleButtonClick}>
            <div className="my-4">
              ...
              <p className="text-sm text-black">
                ...
                0712345678. Kindly provide detailed information about your
                business, including its location (online, shop-based, or
                home-based), the products or services you offer, and any other
                relevant details. Please note that a registration fee of 1000
                Kenyan Shillings is required to become a seller. Once you have
                completed the registration process and submitted the necessary
                information, we will feature your products on our platform,
                making it easy for potential buyers to discover and explore what
                you have to offer.
              </p>
          ...
          {subscribeVisible && (
            ...
            >
              <button
                className="block bg-slate-900 text-white px-4 lg:px-8 ly-2 lg:py-4 rounded-full dark:bg-slate-800"
                onClick={handleButtonClick}
              >
                Subscribe Now
              </button>
