    ...
    <div>
      <div className="container pt-16 pb-16 grid-cols-2">
        ...
        <div className="grid lg:grid-cols-[300px,1fr] gap-4">
          ...
          <div className="bg-red-600 bg-[url(/biashara/cta-banner.jpg)] bg-cover h-[500px] rounded-2xl grid place-items-center">
