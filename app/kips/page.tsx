    ...
    <div className='mx-auto max-w-6xl'>
      <div className='max-w-6xl h-[50vh] relative'>
        ...
        <div className='font-serif text-black absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] z-10 p-2'>
          <h2 className='py-2 font-extrabold text-4xl'>KIPS TECHNICAL COLLEGE</h2>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='font-serif col-span-4'>
          ...
          <p>
          KIPS TECHNICAL COLLEGE is a premier Tertiary Institution established and mandated
          to operate as an Educational Training Institute by TIVET Authority under the Ministry 
          of Higher Education, Science and Technology to offer technical training leading to Artisans, 
          Certificates, Diplomas and higher Diplomas in various Courses.
          </p>
          <a
            href='https://www.kips.ac.ke/'
            target='_blank'
            rel='noreferrer'
          >
            ...
            <div className='p-2'>
              ...
              <div className='grid grid-cols-3 md:grid-cols-1'>
                <p className='text-gray-600 py-2 flex items-center'>
                  ...
                  <a href="https://www.instagram.com/kipstechnical/?hl=en/" target="_blank">Instagram</a>
                </p>
                <p className='text-gray-600 py-2 flex items-center'>
                ...
                <p className='text-gray-600 py-2 flex items-center'>
                  ...
                  <a href="https://www.facebook.com/KIPStechnical/" target="_blank">Facebook</a>
                </p>
                <p className='text-gray-600 py-2 flex items-center'>
                  <ImLocation size={35} className='pr-3' /> 
                  <a href="https://maps.app.goo.gl/YoK2dZBjJqg8uLbA7" target="_blank">Location-kenya</a>
                </p>
                <p className='text-gray-600 py-2 flex items-center'>
