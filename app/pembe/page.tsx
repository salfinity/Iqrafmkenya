            ...
            <div className='p-2'>
              ...
              <div className='grid grid-cols-3 md:grid-cols-1'>
                <p className='text-gray-600 py-2 flex items-center'>
                  ...
                  <a href="https://www.facebook.com/PembeFlourMills/" target="_blank">Instagram</a>
                </p>
                <p className='text-gray-600 py-2 flex items-center'>
                ...
                <p className='text-gray-600 py-2 flex items-center'>
                  ...
                  <a href="https://www.facebook.com/PembeFlourMills/" target="_blank">Facebook</a>
                </p>
                <p className='text-gray-600 py-2 flex items-center'>
                  <ImLocation size={35} className='pr-3' /> 
                  <a href="https://goo.gl/maps/zcsLECdqArFuosbR7" target="_blank">Location-kenya</a>
                </p>
                <p className='text-gray-600 py-2 flex items-center'>
