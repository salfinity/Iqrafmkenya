...
function RadioWindow() {
  const imageWidth = 360; // Set a reasonable width for your images
  const imageHeight = 600; 
  
  return (
   <div className="relative container box-border border-4 border-slate-500 items-center 
    grid grid-cols-4 gap-4 max-w-6xl mx-auto overflow-clip cursor-pointer bg-slate-300 dark:bg-slate-700">
     <div className="absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" >
     <RadioButton />
     </div>
       <div className="w-full rounded m-0 scale-125 dark:blur-sm hover:shadow-xl 
       ...
       <div className="w-full rounded scale-125 ml-auto dark:scale-100 blur-sm dark:blur-none hover:shadow-xl
       transition-all duration-200 ease-in-out">
           <Image 
           layout="fixed"
           width={imageWidth}
