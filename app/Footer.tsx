...
function Footer() {
  ...
  return (  
   <div className="mx-auto max-w-6xl border-t border-gray-100 mt-6 items-center px-4 pb-6 pt-8 sm:px-6 lg:px-8">
     ...
     <div className="mt-16 grid gap-16 border-t border-gray-100 pt-16 md:grid-cols-2 lg:grid-cols-6">
  <div className="md:col-span-2 lg:col-span-1">
    <div className="text-center grid sm:text-left">
      ...
      <ul className="mt-8 space-y-4 text-sm">
        ...
        <li>
          <a className="text-gray-700 cursor-pointer transition dark:text-white hover:text-gray-700/75" onClick={handleManClick}>
            Management
          </a>
        </li>
        <li>
          <a className="text-gray-700 cursor-pointer transition dark:text-white hover:text-gray-700/75" onClick={handleClick}>
            Presenters
          </a>
        </li>
        <li>
          <a className="text-gray-700 cursor-pointer transition dark:text-white hover:text-gray-700/75" onClick={handleScholarsClick}>
            Sheikhs/scholars
          </a>
        </li>
      </ul>
  ...
  <div className="md:col-span-2 lg:col-span-1">
    <div className="text-center grid sm:text-left">
      ...
      <ul className="mt-8 space-y-4 text-sm">
        ...
        <li>
          <a className="text-gray-700 cursor-pointer dark:text-white transition hover:text-gray-700/75" onClick={handleAdvertClick}>
            Advertisements
          </a>
        </li>
        <li>
  ...
  <div className="md:col-span-2 lg:col-span-1">
    <div className="text-center grid sm:text-left">
      ...
      <ul className="mt-8 space-y-4 text-sm">
        ...
        <li>
          <a className="text-gray-700 dark:text-white transition cursor-pointer hover:text-gray-700/75" onClick={handleBusinessClick}>
            Iqra Biashara
          </a>
        </li>
      </ul>
  ...
  <div className="md:col-span-2 lg:col-span-1">
    <div className="text-center grid sm:text-left">
      ...
      <ul className="mt-8 space-y-4 text-sm">
        ...
        <li>
          <a className="group flex justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="sms:+254727444454">
            <span className="text-gray-700 dark:text-white transition group-hover:text-gray-700/75">Live Chat</span>
    ...
    <div className="text-center md:text-left items-center">
      ...
      <div className="mx-auto mt-4 max-w-md sm:ms-0">
        <p className="leading-relaxed dark:text-white text-gray-700 ltr:sm:text-left rtl:sm:text-right">
          IQRA FM, The station with a difference. We love you for the sake of Allah Subhanahu Wataalah.
        </p>
